const FILMS = [
  ...
  { id: "lantern-express", title: "The Lantern Express", year: "AI story", runtime: "6 min read", people: "Lumen Tales", art: "art-lantern", collection: "story", blurb: "At dusk a wooden train appears only for kids who carry a kind light. Mina boards with a cracked lantern and learns the express runs on shared glow: every passenger adds a spark, and the last station is always home." },
  { id: "clockwork-forest", title: "Clockwork Forest", year: "AI story", runtime: "7 min read", people: "Lumen Tales", art: "art-forest", collection: "story", blurb: "Trees tick like clocks and lost minutes hide under moss. Rowan follows a brass bird to a clearing where time has jammed. Winding the great oak one honest turn sends every missing hour back where it belongs." },
  { id: "moonlight-mechanic", title: "Moonlight Mechanic", year: "AI story", runtime: "5 min read", people: "Lumen Tales", art: "art-moon", collection: "story", blurb: "The Moon’s smile slips sideways. A shy repair kid named Sol climbs a ladder of starlight with a tiny wrench, tightens one silver bolt, and the night looks right again." },
  { id: "paper-airship", title: "The Paper Airship", year: "AI story", runtime: "6 min read", people: "Lumen Tales", art: "art-paper", collection: "story", blurb: "Folded from homework and hope, an airship lifts two friends over their town. They deliver lost library books to the right windows before the breeze asks the paper to rest." },
  { id: "silver-map", title: "The Silver Map", year: "AI story", runtime: "8 min read", people: "Lumen Tales", art: "art-map", collection: "story", blurb: "A map drawn in moonlight only shows places you have been brave. Tess draws her first line after helping a neighbor, and a new street appears that leads to a hidden garden." },
  { id: "quiet-orchestra", title: "The Quiet Orchestra", year: "AI story", runtime: "5 min read", people: "Lumen Tales", art: "art-orchestra", collection: "story", blurb: "Instruments wake at midnight but play only if someone listens kindly. A boy who cannot sleep conducts with a wooden spoon, and the town dreams in the same gentle key." }
];
